/*
 * Extracted from the sample source code repository:
 * https://github.com/sf105/goos-code/blob/master/src/auctionsniper/util/Announcer.java
 */
package goos.auction_sniper.util;
